          ...
          <div className="container" style={containerStyle}>
            <Form onSubmit={formik.handleSubmit}>
              <div className="row">
                ...
                <div className="col-12 col-md-4 col-sm-12 col-lg-4 my-2">
                  <button className={styles.btntop}>Upload New Image</button>
                  <button className={styles.btntop}>Remove Image</button>
                </div>
                <div className="col-12 col-md-4 col-sm-12 col-lg-4 my-2"></div>
                <div className="col-12 col-md-4 col-sm-12 col-lg-4 my-2">3</div>
              </div>
              <div className="row">
